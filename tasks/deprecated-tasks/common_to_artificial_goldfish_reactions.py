...
that reaction time is strongly related to previous location.
'''
...
def get_reaction_sequences(input_files):
    ...
    for seq in iter_sequence_files(input_files):
        ...
        for first_sec in iter_target_periods(seq):
            ...
            if previous_aoi_index is None:
                srt = 160000
                dur = 16000
            else:
                if previous_aoi_index == stim_aoi_index:
                    srt = 120000
                    dur = 12000
                else:
                    srt = 200000
            ...
            previous_aoi_index = stim_aoi_index
